...
* Open the file `html-template.html` (Solved) and `style.css` (Solved) in Sublime. Then walk students through the following points:
...
* Walk students through the process of incorporating a Google Font. You can use the below steps as a guide.
  ...
  * Then open the file `html-template.html` (08-GoogleFontDemo > Unsolved) first in the browser and then in Sublime. Point out that its the same file they worked with just now.
